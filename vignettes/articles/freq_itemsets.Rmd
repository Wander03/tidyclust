...
- Itemsets with the highest support are selected as the "dominate" itemset for the item

- If there is a tie in support, the largest itemset is selected
...
# Convert new_data to a matrix for efficient processing
...
for (i in seq_len(nrow(new_data))) {
  ...
  for (item in missing_items) {
    ...
    probabilities <- sapply(seq_along(relevant_itemsets), function(idx) {
      ...
      # Aggregate probabilities (e.g., using mean)
